Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://salesforce-async-messaging.s3.amazonaws.com/public/ios/1.11.1/SMIMultimediaCore-Release.xcframework.zip" }

  spec.vendored_frameworks = 'SMIMultimediaCore.xcframework'
  spec.dependency 'Messaging-Multimedia-Common', '1.11.1'
