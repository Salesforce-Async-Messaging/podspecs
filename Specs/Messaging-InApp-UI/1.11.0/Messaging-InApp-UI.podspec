Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://salesforce-async-messaging.s3.amazonaws.com/public/ios/1.11.0/SMIClientUI-Release.xcframework.zip" }

  spec.vendored_frameworks = 'SMIClientUI.xcframework'
  spec.dependency 'Messaging-InApp-Core', '1.11.0'
